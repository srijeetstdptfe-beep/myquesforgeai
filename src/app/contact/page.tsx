...
import { Mail, Phone, MapPin, Send, MessageSquare, Clock, Shield, ChevronRight } from "lucide-react";
...
export default function ContactPage() {
    ...
    return (
        <div className="min-h-screen bg-white selection:bg-black selection:text-white">
            {/* Navbar Placeholder to match styling if needed, or assume a layout wrapper exists */}
            ...
            <div className="py-20 border-t border-black/5">
                <div className="max-w-7xl mx-auto px-6 text-center italic text-slate-400 font-medium">
